...
public class ModifyShift extends Activity {
    ...
    protected Dialog onCreateDialog (int id) {
    	...
    	case START_TIME_PICKER:
    		return new TimePickerDialog (this, TimeSetListenerStart, startTime.getHours(), startTime.getMinutes(), false);
    	case END_TIME_PICKER:
    		return new TimePickerDialog (this, TimeSetListenerEnd, endTime.getHours(), endTime.getMinutes(), false);
    	}
    	return null;
